    ...
    public function run(): void
    {
        ...
        $coursesData = [
            [
                ...
                'description' => 'Baca dan pahami materi terkait Organisasi Pergerakan berikut ini! Jika sudah, coba tanyakan Asisten Patih AI terkait awal perjalanan Anda dalam mempelajari Sejarah Indonesia lebih lanjut, Anda bisa memulai percakapan dengan mengirimkan pesan \'Halo\' di kolom chat.',
                'order' => 1,
            ...
            [
                ...
                'description' => 'Bacalah materi terkait bagaimana peran para Tokoh Pergerakan Nasional dalam merancang Sumpah Pemuda yang kita kenal saat ini! Selanjutnya, coba tanyakan Patih AI untuk terkait materi ini, Anda juga bisa berdialog dengan tokoh-tokoh tertentu untuk menggali informasi lebih dalam!',
                'order' => 2,
            ...
            [
                ...
                'description' => 'Bacalah materi tentang proses kongres pemuda dan hasil dari kongres tersebut pada materi berikut ini! Jika sudah membaca materi, Anda bisa dapat melanjutkan bertanya ke Patih AI dan merasakan suasana yang imersif dalam momen-momen puncak Kongres Pemuda II.',
                'order' => 3,
            ...
            [
                ...
                'description' => 'Sebagai tahap akhir investigasi, sintesiskan pemahaman kamu mengenai Kongres Pemuda II. Integrasikan perspektif tokoh (M. Yamin/Soegondo) berdasarkan wawancara yang kamu lakukan dan suasana kebatinan kongres ke dalam satu artikel berita yang padu. Tuliskan minimal 200 kata dan diskusikan kerangka tulisan kamu bersama Patih AI',
                'order' => 4,
